...
public class PostpaidToHybrid extends BasePage {
	public PostpaidToHybrid(TestContext context) {
		super(context);
	}
	//Migration Page
			...
			public void postpaid_hybrid(CorpCustomer customer,String planname) {
